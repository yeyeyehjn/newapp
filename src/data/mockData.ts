import { Case, Task, ArbitratorProfile, TranscriptSignature, PostponementApproval } from '../types';
...
export const mockCases: Case[] = [
  // Original cases
  {
    ...
    hearings: [
      { id: "h1_1", hearingTime: "2026-03-05 09:30 至 12:00", location: "第一仲裁庭", status: "已结束", notes: "开庭顺利，对双方主要事实争议进行了深度辩论。" },
      { id: "h1_2", hearingTime: "2026-06-11 09:30 至 11:30", location: "第二仲裁庭", status: "待开庭", notes: "开庭" }
    ]
  },
  {
    id: "2",
  ...
  },
  {
    ...
    hearings: [
      { id: "h3_1", hearingTime: "2026-06-12 14:00 至 16:30", location: "东莞分会五庭", status: "待开庭", notes: "开庭" }
    ]
  },
  {
    id: "4",
    ...
    hearings: [
      { id: "h4_1", hearingTime: "2025-12-15 09:30", location: "第十九仲裁庭", status: "已结束", notes: "技术细节展示充分，焦点定于发明是职务发明还是王某某之前已有的自研原型上。" }
    ]
  },
  {
    id: "5",
    ...
    hearings: [
      { id: "h5_1", hearingTime: "2026-06-12 15:30 至 17:30", location: "第十九仲裁庭", status: "待开庭", notes: "鉴定" }
    ]
  },
...
export const mockTranscriptSignatures: TranscriptSignature[] = [
  {
    id: "ts_1",
    caseNo: "(2026)穗仲案字第1024号",
    claimant: "华夏科技公司",
    ...
    secretary: "李文浩",
    arbitrator: "张明（首席）",
    hearingTime: "2026-06-11 09:30-12:00",
    status: "pending"
  },
  {
    id: "ts_2",
    ...
    secretary: "陈思雨",
    arbitrator: "张明（边裁）",
    hearingTime: "2026-06-12 14:00-17:00",
    status: "pending"
  },
  {
    id: "ts_3",
    ...
    secretary: "王志强",
    arbitrator: "张明（首席）",
    hearingTime: "2026-06-10 09:00-12:00",
    status: "signed",
    signedAt: "2026-06-10 12:30"
  },
  {
    id: "ts_4",
    caseNo: "(2026)穗仲案字第0888号",
    claimant: "东方贸易公司",
    respondent: "西方物流集团",
    secretary: "李文浩",
    arbitrator: "张明（独任）",
    hearingTime: "2026-06-13 09:30-11:30",
    status: "pending"
  },
  {
    id: "ts_5",
    caseNo: "(2026)穗仲案字第0666号",
    claimant: "金融投资公司",
    respondent: "资产管理集团",
    secretary: "陈思雨",
    arbitrator: "张明（边裁）",
    hearingTime: "2026-06-09 14:00-16:00",
    status: "signed",
    signedAt: "2026-06-09 16:15"
  }
];

export const mockPostponementApprovals: PostponementApproval[] = [
  {
    id: "pa_1",
    caseNo: "(2026)穗仲案字第1024号",
    claimant: "华夏科技公司",
    ...
    secretary: "李文浩",
    arbitrator: "张明（首席）",
    reason: "申请人代理人因出差无法按时参加庭审",
    originalHearingTime: "2026-06-11 09:30",
    requestedTime: "2026-06-18 09:30",
    requestTime: "2026-06-10 14:00",
    status: "pending",
    flowRecords: [
      {
        operator: "办案秘书 李文浩",
  ...
  },
  {
    ...
    secretary: "陈思雨",
    arbitrator: "张明（边裁）",
    reason: "被申请人需要补充提交证据材料",
    originalHearingTime: "2026-06-12 14:00",
    requestedTime: "2026-06-20 14:00",
    requestTime: "2026-06-11 10:00",
    status: "pending",
    flowRecords: [
      {
        operator: "办案秘书 陈思雨",
  ...
  },
  {
    ...
    secretary: "王志强",
    arbitrator: "张明（首席）",
    reason: "双方当事人协商需要更多准备时间",
    originalHearingTime: "2026-06-10 09:00",
    requestedTime: "2026-06-15 09:00",
    requestTime: "2026-06-09 16:00",
    status: "approved",
    approvedTime: "2026-06-09 17:30",
    flowRecords: [
      {
        operator: "办案秘书 王志强",
  ...
  },
  {
    ...
    arbitrator: "张明（独任）",
    reason: "申请人申请更换代理人",
    originalHearingTime: "2026-06-13 09:30",
    requestedTime: "2026-06-25 09:30",
    requestTime: "2026-06-12 08:00",
    status: "rejected",
    approvedTime: "2026-06-12 10:00",
    flowRecords: [
      {
        operator: "办案秘书 李文浩",
